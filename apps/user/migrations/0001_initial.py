# Generated by Django 4.0.3 on 2022-04-10 11:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exp_time', models.DateTimeField(blank=True, default=datetime.datetime(2022, 4, 11, 11, 46, 0, 284082, tzinfo=utc), verbose_name='Token过期时间')),
                ('login_time', models.DateTimeField(auto_now=True, verbose_name='登录时间')),
                ('last_login_time', models.DateTimeField(blank=True, default=django.utils.timezone.now, verbose_name='上次登录时间')),
            ],
            options={
                'verbose_name': '用户',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courseTeacher', models.ManyToManyField(to='user.teacher')),
            ],
            options={
                'verbose_name': '课程',
