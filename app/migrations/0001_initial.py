    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scoreStudent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.student')),
            ],
            options={
                'verbose_name': '成绩',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courseStudent', models.ManyToManyField(to='app.student')),
                ('courseTeacher', models.ManyToManyField(to='app.teacher')),
            ],
            options={
                'verbose_name': '课程',
